...
For all that I have observed and participated in plenty of discussions
about one or another piece of software as to whether it is or is not
good, I am surprised to say that I have never seen READMORE a single defining
principle clearly articulated.  Permit me, therefore, to propose this
one:

> Good software is software that admits a simple mental model.

Or, more precisely, software is better inasmuch as the
simplicity-accuracy curve for models of it is more favorable.

Let us consider some generally avowed qualities of good software and
see how they relate to mental models.

- "Good software works."  One can view this desideratum as separate
  ...
  than a detailed understanding of how that task is performed.

- "Good software is robust [to unusual conditions]."  This desideratum
...
- "Good software is maintainable."  What is software maintenance?
  ...
  and of what will happen under various possible changes.

- "Good software is reusable."  That is, the people in a position to
  ...
  things, because complexity only arises when dealing with specifics.

- "Good software is extensible."  This one is about decomposing the
...
- "Good software is debuggable."  Meaning that it produces sufficient
...
- "Good software is secure."  This desideratum can also be viewed as
...
- "Good software is modular."  That is, it is broken down into parts
...
- "Good software is testable."  That is, it should be easy to compare
  one's mental model of the software (or some part of it) against the
  reality.

- "Good software is efficient."  In one sense, calling this one as
...
- "Good software is scalable."  That is, it's easy and favorable
  ...
  resources one would think it should.

- "Good software is learnable."  That is, the simplicity/accuracy
  curve of mental models of the software is not too difficult to
  traverse towards greater accuracy.

- "Good software has few bugs."  What is a bug?  It is a discrepancy
  ...
  one component is not properly met by another.

- "Good software is compatible [with the surrounding ecosystem]."
  ...
  appreciate how much work this is!

Which brings me to a critical corollary of my proposed principle:
...
because my fingers don't know any other sets of keybindings.

> Software is good in your eyes if you can easily form a good mental
> model of it.

Notes
-----

Perhaps the relativity of the goodness of software is at the root of
...
assumed to be worth understanding regardless.
